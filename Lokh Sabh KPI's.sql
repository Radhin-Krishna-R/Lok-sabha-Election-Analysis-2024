...
WHERE s.State = 'Kerala' AND cr.Constituency_Name = 'THIRUVANATHAPURAM';



--What is the distribution of EVM votes versus postal votes for candidates in a Kozhikode?
...
--Which candidate won and which candidate was the runner-up in each constituency of State Goa for the 2024 elections?
...
--For the state of Kerala, what are the total number of seats, total number of candidates, total number of parties, total votes (including EVM and postal), and the breakdown of EVM and postal votes?
SELECT 
